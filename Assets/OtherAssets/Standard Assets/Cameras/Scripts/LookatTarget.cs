...
namespace UnityStandardAssets.Cameras
{
    public class LookatTarget : AbstractTargetFollower
    {
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            Vector3 localTarget = transform.InverseTransformPoint(m_Target[MevcudTarger›ndex].position);
            ...
            localTarget = transform.InverseTransformPoint(m_Target[MevcudTarger›ndex].position);
