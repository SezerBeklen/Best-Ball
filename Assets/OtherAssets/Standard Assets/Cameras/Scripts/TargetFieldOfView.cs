...
namespace UnityStandardAssets.Cameras
{
    public class TargetFieldOfView : AbstractTargetFollower
    {
        ...
        {
            base.Start();
            m_BoundSize = MaxBoundsExtent(m_Target[MevcudTarger›ndex], m_IncludeEffectsInSize);
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            float dist = (m_Target[MevcudTarger›ndex].position - transform.position).magnitude;
