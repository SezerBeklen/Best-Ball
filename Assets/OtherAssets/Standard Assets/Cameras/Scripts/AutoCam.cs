...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            if (!(deltaTime > 0) || m_Target[MevcudTarger›ndex] == null)
            {
                return;
            }

            // initialise some vars, we'll be modifying these in a moment
            var targetForward = m_Target[MevcudTarger›ndex].forward;
            var targetUp = m_Target[MevcudTarger›ndex].up;
            ...
            transform.position = Vector3.Lerp(transform.position, m_Target[MevcudTarger›ndex].position, deltaTime*m_MoveSpeed);
